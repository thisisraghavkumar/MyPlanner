    ...
    public class InMemoryTasks : IPlannerTasks
    {
        ...
        public InMemoryTasks()
        {
            ...
            this.userTasks = new List<PlannerTask>()
            {
                ...
                new PlannerTask {Id = 3, Subject = "Task 3 not Important but Urgent", Due = timeNow.AddDays(2), IsImportant = false, IsUrgent = true, TotalSteps = 3, CompletedSteps = 2, Steps = "Hours"},
